...
/*
    ...
    aplicacoes Android ela deve sempre ser usada em conjunto com AsyncTask para garantir que a app
    nao ira travar por conta da espera de resposta do servidor web.
